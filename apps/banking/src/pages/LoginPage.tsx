    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-4 py-10">
      <div className="w-full max-w-md space-y-4">
        <div className="text-center">
          <h1 className="text-2xl font-semibold text-slate-900">FinSecure Bank</h1>
          <p className="mt-1 text-sm text-slate-600">Demo banking platform — sign in to continue</p>
        </div>
